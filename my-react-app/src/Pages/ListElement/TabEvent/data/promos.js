...
const promos = [
  {
    ...
    img: "../../public/promotion/zalopay-2_1756131451068.jpg",
    href: "/uu-dai/zalopay",
    provider: "ZaloPay",
  ...
  },
  {
    ...
    img: "../../public/promotion/lio-t9-galaxy-banner-app-1135x660_1758894341772.jpg",
    href: "/uu-dai/liobank",
    provider: "Liobank",
    discountType: "amount",
    discountValue: 60000,
  ...
  },
  {
    ...
    img: "../../public/promotion/click-to-pay-visa-1_1756349730515.jpg",
  ...
  },
  {
    ...
    img: "../../public/promotion/1135-sym-tan-an_1758187407676.jpg",
  ...
  },
  {
    ...
    img: "../../public/promotion/momo-galaxy-2_1756958593143.jpg",
  ...
  },
  {
    ...
    img: "../../public/promotion/imax-treasure-hunt-5_1758703687529.jpg",
  ...
  },
{
  ...
  desc: "Bán lẻ đồng giá 35K/bịch. Mua kèm combo bắp nước chỉ 25K/bịch (áp dụng điều kiện).",
  img: "/promotion/1135_1742541023469.jpg",
  href: "/uu-dai/snack-du-vi",
  provider: "Galaxy Cinema",
  discountType: "amount",
  discountValue: 25000,                 // giá ưu đãi khi mua kèm combo
  startAt: "2025-04-01",
  endAt: null,                          // banner không ghi ngày kết thúc
  tags: ["f&b", "snack", "combo"],
  priority: 10,
  isActive: true,
...
{
  id: "bap-com-2025-10",
  title: "Bắp Cốm – vị mới theo mùa",
  desc: "Thưởng thức bắp vị cốm thơm ngon. Áp dụng từ 01/10 đến 30/11.",
  img: "/promotion/1135_1761895921963.jpg",
  href: "/uu-dai/bap-com",
  provider: "Galaxy Cinema",
  discountType: "none",
  discountValue: null,
...
console.log("loaded promos FROM:", import.meta.url, "COUNT:", promos.length);
