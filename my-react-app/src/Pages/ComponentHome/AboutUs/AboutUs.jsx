  ...
  return (
    <section className="relative z-10 my-24 md:my-1 min-h-[40vh] bg-[#0b0e16] text-white">
      <div className="mx-auto max-w-7xl px-6 pt-6 pb-12 grid gap-10 lg:grid-cols-2 items-center">
        ...
        <div>
          <span className="text-xs tracking-widest text-white/60">ABOUT US</span>
          <h1 className="mt-2 text-3xl md:text-5xl font-bold">
            Hệ thống rạp chiếu phim <span className="text-sky-400">Aurora</span>
          </h1>

          <p className="mt-4 text-white/80 leading-relaxed">
            Aurora là cụm rạp thế hệ mới hướng đến trải nghiệm “đã mắt – đã tai – đã lòng”.
            Chúng tôi trang bị màn hình Laser 4K, âm thanh Dolby Atmos, ghế đôi &amp; ghế
            VIP da thật, cùng hệ thống đặt vé nhanh trong 10 giây.
          </p>
          <ul className="mt-6 space-y-3 text-white/85">
            <li>• 08 phòng chiếu tiêu chuẩn quốc tế, hơn 1.200 chỗ ngồi.</li>
            <li>• Lịch chiếu dày, nhiều suất đêm cho fan phim.</li>
            <li>• Combo bắp – nước phong phú, khu chờ chill &amp; photobooth.</li>
    ...
    />
        ...
        <div className="flex justify-center">
          <ProfileCard
            ...
            contactText="Liên hệ"
            avatarUrl="../../../../public/80801-BODY_ (15).jpg"      // ảnh trong public/images/cinema.jpg
